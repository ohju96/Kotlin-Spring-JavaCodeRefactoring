...
class BookServiceTest @Autowired constructor(
    ...
    fun clean() {
        ...
        userRepository.deleteAll() //자식 테이블의 정보도 찾아서 삭제해준다.
    }
    ...
    fun loanBookTest() {
        ...
        val request = BookLoanRequest("오주현", "이상한 나라의 엘리스")
    ...
    fun countLoanedBookTest() {
        //given
        val savedUser = userRepository.save(User("오주현", null))
        ...
        //when
        val result = bookService.countLoandBook()
